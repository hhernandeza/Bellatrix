...
namespace UnitTestProject1
{
    ...
    {
        //THE PARAMETER TYPEMESSAGE IS 2 (WARNING)
        //<add key="TypeMessage" value="2" /><!--warning :  2-->
        [TestMethod]
         public void TestMethod1()
        {
            ...
            Assert.Inconclusive("Verify: it musn´t log the message if the parameter TypeMessage is TypeMessage.message");
        }
